...
if nav == "Customer Review":
    ...
    if st.button("Predict"):
        ...
        br = TextBlob(cleaned_review)
        result = br.sentiment.polarity
        if result < 0:
            st.success("This is a Negative Massage")
        elif result >= 0.01:
        ...
        sentiment = TextBlob(cleaned_review).sentiment
        # st.write(sentiment)
        ...
        token_sentiments = analyze_token_sentiment(cleaned_review)
